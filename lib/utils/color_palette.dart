...
var appThemeLight = ThemeData(
  ...
  hintColor: Palette.hintColorLight,
  brightness: Brightness.light,
  scaffoldBackgroundColor: Palette.grey_1,
  ...
  tabBarTheme: TabBarTheme(
    unselectedLabelColor: Palette.iconTint,
    labelColor: Palette.primaryColor,
    unselectedLabelStyle: _textThemeLight.copyWith(fontSize: _baseFontSize),
    indicator: BoxDecoration(
        border:
            Border(bottom: BorderSide(color: Palette.primaryColor, width: 2))),
    labelStyle: _textThemeLight.copyWith(
      fontSize: _baseFontSize,
      fontWeight: FontWeight.bold,
    ),
  ),
  iconTheme: IconThemeData(color: Palette.iconTint),
  primaryTextTheme: TextTheme(
    ...
    subtitle1: _textThemeLight.copyWith(
        fontSize: 32, fontWeight: FontWeight.bold, color: Palette.black),
    subtitle2: _textThemeLight.copyWith(
        fontWeight: FontWeight.w400, color: Palette.iconTint),
